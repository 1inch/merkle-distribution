    ...
    describe('Contract Deployment and Verification', () => {
        ...
        it('should execute full drop task with actual deployment', async () => {
            ...
            const hre = {
                ...
                deployments: {
                    ...
                    deploy: async (_name: string, options: { args: unknown[] }) => {
            ...
            await dropTask(hre as any, { // eslint-disable-line @typescript-eslint/no-explicit-any
                a: '1',      // 1 ETH per drop
                n: '5',      // 5 recipients
                v: '1001',   // version
        ...
        it('should handle claim process with signature verification', async () => {
            ...
            try {
                ...
                expect(errorMessage).to.include('DropAlreadyClaimed');
            }
        });
    });
