...
describe('Hardhat Tasks E2E Tests', () => {
    ...
    getNamedAccounts: sinon.SinonStub;
  };
    ...
    describe('generateLinks', () => {
        it('should generate merkle drop links with real file operations', async () => {
            ...
            const savedUrls = savedLinksData.codes.map((code: { url: string }) => code.url);
    ...
    describe('dropTask', () => {
        it('should execute full drop flow in debug mode', async () => {
            ...
            // Using any here due to complex HRE type compatibility
            await dropTask(mockHRE as any, { // eslint-disable-line @typescript-eslint/no-explicit-any
                a: '1,2',     // amounts
                n: '5,10',    // counts
                v: '100',     // version
    ...
    describe('verifyDeploymentTask', () => {
        it('should verify deployed contract', async () => {
            ...
            // Using any here due to complex HRE type compatibility
            await verifyDeploymentTask(mockHRE as any, '100'); // eslint-disable-line @typescript-eslint/no-explicit-any
        ...
        it('should handle missing deployment', async () => {
            ...
            // Using any here due to complex HRE type compatibility
            await verifyDeploymentTask(mockHRE as any, '999'); // eslint-disable-line @typescript-eslint/no-explicit-any
